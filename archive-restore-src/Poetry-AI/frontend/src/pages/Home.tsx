...
const recentLessonCards = [
  { title: "静夜思", meta: "已完成精讲 + 记忆", to: "/learn" },
  { title: "望岳", meta: "解析完成，待练测", to: "/practice?entry=practice&topic=望岳&count=8&difficulty=medium" },
  { title: "水调歌头", meta: "图谱关联已解锁", to: "/graph" },
] as const;
...
const homeLoopRecommendations = [
  {
    title: "做同诗练测",
    description: "从《春望》的理解立刻过渡到题目训练，验证是否真正掌握意象与情感。",
    to: "/practice?entry=practice&topic=春望&count=8&difficulty=medium&auto=1&source=home",
    ctaLabel: "去练测",
    badge: "学完后",
  },
  {
    ...
    to: "/graph?highlight=春望&view=poet",
    ctaLabel: "去图谱",
    badge: "理解后",
  },
  {
                    ...
                    <div key={item.label} className="text-center">
                      <div className="h-16 rounded-2xl bg-stone-200 p-1">
                        <div
                          ...
                          style={{ opacity: Math.max(0.2, item.value / 100) }}
                        />
                      </div>
